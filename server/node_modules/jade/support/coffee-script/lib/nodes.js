(function() {
  ...
  exports.Class = (function() {
    ...
    Class.prototype.compileNode = function(o) {
      ...
      for (_i = 0, _len = (_ref2 = this.properties).length; _i < _len; _i++) {
        ...
        if (func instanceof Code && func.bound) {
          if (prop.context === 'this') {
            ...
            my || (my = constScope.freeVariable('this'));
            pname = pvar.compile(o);
            if (constructor.body.empty()) {
              constructor.body.push(new Return(new Literal('this')));
            }
            constructor.body.unshift(new Literal("this." + pname + " = function(){ return " + className + ".prototype." + pname + ".apply(" + my + ", arguments); }"));
          }
        }
        if (pvar) {
      ...
      if (my) {
        constructor.body.unshift(new Literal("" + my + " = this"));
      }
