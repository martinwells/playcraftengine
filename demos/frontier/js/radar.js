...
RadarComponent = pc.components.Component.extend('RadarComponent',
    {
    },
    {
        init:function ()
...
RadarSystem = pc.EntitySystem.extend('RadarSystem',
    {},
    {
        entityManager:null,
        gameLayer: null,
        ...
        process:function (entity)
        {
            ...
            if (!this.player)
            {
                this.player = this.entityManager.getEntitiesWithTag('PLAYER').first.obj;
            ...
            var enemies = this.entityManager.getEntitiesWithTag('ENEMY');
            if (enemies)
            {
