...
(function(a) {
  ...
  a.prototype.DrawCircle = function(a, c, d) {
    if(c) {
      ...
      e.beginPath();
      e.strokeStyle = this._color(d.GetColor(), this.m_alpha);
      e.arc(a.x * f, a.y * f, c * f, 0, 2 * Math.PI, !0);
      e.closePath();
      e.stroke()
    }
  };
  a.prototype.DrawSolidCircle = function(a, c, d, e) {
    if(c) {
      var f = this.m_ctx, g = this.m_drawScale, h = a.x * g, i = a.y * g;
      f.moveTo(0, 0);
      f.beginPath();
      ...
      f.moveTo(h, i);
      f.lineTo((a.x + d.x * c) * g, (a.y + d.y * c) * g);
      f.closePath();
      f.fill();
      f.stroke()
    }
  ...
  a.prototype.DrawTransform = function(a) {
    ...
    c.moveTo(a.position.x * d, a.position.y * d);
    c.lineTo((a.position.x + this.m_xformScale * a.R.col1.x) * d, (a.position.y + this.m_xformScale * a.R.col1.y) * d);
    c.strokeStyle = this._color(65280, this.m_alpha);
    c.moveTo(a.position.x * d, a.position.y * d);
    c.lineTo((a.position.x + this.m_xformScale * a.R.col2.x) * d, (a.position.y + this.m_xformScale * a.R.col2.y) * d);
    c.closePath();
    c.stroke()
  }
