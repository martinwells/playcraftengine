                    ...
                    for (var b = 0; b < em.burst; b++)
                    {
                        ...
                        em._particles.add(
                            pc._Particle.create(
                                ...
                                pc.Math.rand(em.thrustMin, em.thrustMax),
                                pc.Math.rand(em.lifeMin, em.lifeMax),
                                pc.Math.rand(em.spinMin, em.spinMax),
                                pc.Math.rand(em.scaleXMin, em.scaleXMax),
                                pc.Math.rand(em.scaleYMin, em.scaleYMax),
