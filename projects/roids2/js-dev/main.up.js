...
GamePhysics = pc.systems.Physics.extend('GamePhysics',
    {},
    {
        ...
        onCollisionStart:function (aType, bType, entityA, entityB, fixtureAType, fixtureBType, contact)
        {
			...
			//entityA.layer.scene.hudShipType.getComponent('text').text[0] = 'Ship Type: ' + entityA.layer.scene.Fighter.desc;
...
TheGame = pc.Game.extend('TheGame',
    {},
    {
		...
		{
			//Fullscreen Images
            //pc.device.loader.add(new pc.Image('publisher', 'images/publisher.png'));
